Zero SAC Inbound
**Zero Quantity Line Item Rule**
* When Item Quantity (IT102) is sent as 0, load as 1
* When Item Quantity (IT102) is sent as 0, load Price (IT104) as 0.00
 
##**Line Item SAC**
Coded SAC records are written under each line item and should be loaded as (+/-) adjustments based on the charge indicator.
 
SAC cost is also written as integer which will be converted to double, although 2 digit values should be converted right of the decimal.
